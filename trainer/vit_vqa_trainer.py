...
class ViTVQATrainer:
    ''' 
    Trainer Class for Vision Transformer and T5-base multi-modal pipeline. 
    '''
    def __init__(
        self, 
        model:VitVQAModel,
        ...
        ''' 
        Initializes all the necessary training hyperparameters. The hyperparameters are present in the vit_daquar_config json. 
        '''
    ...
    def _init_optimizer(self, optimizer_kwargs:dict, load_from_checkpoint:bool):
        ...
        param_dict.append({
            "params":self.model.fusing_layer.parameters(), "lr": optimizer_kwargs["classifier_lr"], "model_name":"Fusion Layer"
        })        
