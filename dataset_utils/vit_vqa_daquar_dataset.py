...
class DaquarVitT5CollateFn(object):
    '''
    Custom Dataloader Class to preprocess DAQUAR dataset inputs for ViT based Multi-Modal Pipeline.
    '''
    def __init__(self, 
                image_model:str, 
                lang_model:str,
        ...
        ''' 
        image_model - To create instance of image_preprocess
        ...
        # Present in OK-VQA dataset. Not DAQUAR dataset
    ...
    def collect_preprocessed_data(self, data_points):
        ...
        for annotation in annotations:
            ''' 
            randomly select a single choice from list of answers. (Multiple Answers for a single Question)
            '''
            ...
            if answer in self.answer_spaces:
                ...
                random_answer_choices.append(self.answer_spaces.index('O')) #Out-of-Vocab (Out of Answer Spaces)
        ...
        # Add [QUESTION] special token to the input text. Logic Similar to [CLS] token in BERT
